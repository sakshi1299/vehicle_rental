    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Vehicle Returns</h1>
          <p class="mb-4">All Vehicle Returns.</p>
                  ...
                  <%
                      ...
                      try
                      {
                         DB d=new DB();
                          ...
                          {
                             %> 
                             <form action="action_ret.jsp" method="post">
                             <tbody>
                                 <tr>
                                 ...
                                 <td><a href="action_ret.jsp?name=<%=rs.getString(1)%>"   class="btn btn-info">
                                         Confirm
                            </a></td></tr>
                          </tbody>
                          </form>
